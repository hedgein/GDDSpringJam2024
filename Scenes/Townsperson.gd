...
@export var die_sides_a = [1,1,1,1,1,2] # each of these dice is customizable based on the person's character (their soul)
...
<<<<<<< Updated upstream
=======
@export var cheats : float = 1.0 # chance that the character will cheat; range between 0 and 1
